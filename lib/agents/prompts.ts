...
const COMMON = [
  ...
  "6. Write every rupee figure in full, exactly as the tool gave it. Never rescale into lakh, crore, million or thousand, and never spell a figure out in words.",
  "7. Never claim an outcome the tool did not report. If a result says something is not achievable, say so; do not present the nearest value as though it were the answer.",
  "",
